...
def MakeTreeData(GenomeDatabase, marker_ids, genome_ids, directory, prefix=None, config_dict=None):
    ...
    gg_fh = open(os.path.join(directory, prefix + "_concatenated.arbtxt"), 'w')
    fasta_concat_fh = open(os.path.join(directory, prefix + "_concatenated.faa"), 'w')
    marker_info_fh = open(os.path.join(directory, prefix + "_concatenated_markers.info"), 'w')
    multi_hits_fh = open(os.path.join(directory, prefix + "_multi_hits.info"), 'w')
